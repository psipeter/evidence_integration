...
==================================
ROLE: this is the CURRENTLY ACTIVE / PRODUCTION generation method. The
promoted 6x4 pilot (task/sequences/{continuous,binary}_sequences.{pkl,json})
was generated by this script via a 1000-try isotonic seed search and is
what real participants actually run. For the pending 10x4 full-experiment
design, this is one of two candidates still being weighed against
generate_sequences_iid.py (see CLAUDE.md's "PI decision pending" note) --
not yet finalized at that larger scale.
