 ...
 * Mirrors plugin-tutorial-summary-continuous.js's identical pattern for
...
import { DIST_COLOR } from './urn-binary.js';
...
class TutorialSummaryBinaryPlugin {
  ...
  trial(display_el, trial) {
    ...
    // mirrors continuous's identical meanWord swap, using binary's own
    // established "ratio" terminology (tutorial-text-binary.js) rather
