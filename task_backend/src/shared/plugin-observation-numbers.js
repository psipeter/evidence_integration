 ...
 * shared with plugin-observation-colors.js (this logic used to be duplicated
...
class ObservationNumbersPlugin {
  constructor(jsPsych) {
...
ObservationNumbersPlugin.info = info;
export default ObservationNumbersPlugin;
