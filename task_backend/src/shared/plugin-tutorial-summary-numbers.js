/**
 * plugin-tutorial-summary-numbers.js
 * End-of-tutorial summary (numbers task) using the same performance
 ...
 * plugin-trial-summary-numbers.js's positioning exactly -- the banner
 * is the one thing that screen doesn't have.
 */

import { buildPerformanceSVG, COIN_FILL, ERROR_GREEN, MEAN_BLUE } from './draw-performance-numbers.js';

const info = {
  name: 'tutorial-summary-numbers',
  parameters: {
...
class TutorialSummaryNumbersPlugin {
  constructor(jsPsych) {
...
TutorialSummaryNumbersPlugin.info = info;
export default TutorialSummaryNumbersPlugin;
