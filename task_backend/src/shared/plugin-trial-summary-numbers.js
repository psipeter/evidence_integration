/**
 * plugin-trial-summary-numbers.js
 * Inter-trial summary — numbers task.
 * Identical layout to plugin-tutorial-summary-numbers.js. The one
 ...
 * no separate append call needed. scoring.js's own docstring has
 * the full formula/rationale.
 */
import { buildPerformanceSVG, COIN_FILL, ERROR_GREEN } from './draw-performance-numbers.js';

const info = {
  name: 'trial-summary-numbers',
  parameters: {
...
class TrialSummaryNumbersPlugin {
...
TrialSummaryNumbersPlugin.info = info;
export default TrialSummaryNumbersPlugin;
