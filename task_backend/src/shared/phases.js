 ...
 * task_backend/TODO.md's schema) -- deliberately coarser than the old
 * JATOS pipeline's per-screen tagging (17 distinct `screen` values found
 * during the port review pass). Only welcome/consent/tutorial/trial ever
 * need a checkpoint call; the rest of the old screen taxonomy (ITI resets,
 * summary screens, tutorial intro/complete transitions) needs no network
 * call at all under the trial-boundary-resume design -- see TODO.md
 * decision #3.
 *
