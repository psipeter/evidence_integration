 ...
 *
 * `color` is a parameter (not hardcoded) so this can be reused for colors's
 * blue/red draws -- numbers passes a fixed color string; colors
 ...
 * separate "number" to show for a colors draw, the color IS the content,
