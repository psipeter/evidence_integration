...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--lmu_order", type=int, default=_NEF_FIXED["lmu_order"])
    p.add_argument("--lmu_tau", type=float, default=_NEF_FIXED["lmu_tau"])
    p.add_argument("--lmu_n_obs_max", type=int, default=_NEF_FIXED["lmu_n_obs_max"])
    p.add_argument(
        "--lmu_theta_mult",
        type=float,
        default=_NEF_FIXED["lmu_theta_mult"],
    )
    p.add_argument(
        "--onset_detector_amp",
        type=float,
