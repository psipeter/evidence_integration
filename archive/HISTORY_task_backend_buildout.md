# archive/HISTORY_task_backend_buildout.md — task_backend build-out and deployment history

Archived, frozen narrative. For current task_backend conventions see
task_backend/CLAUDE.md; for the decisions here, see docs/DECISIONS.md.
