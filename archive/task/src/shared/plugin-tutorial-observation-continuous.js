 ...
 *                    observation-continuous.js's `stopClock`), so nothing
...
import { BOX0, BOX0B, BOX1, BOX2, SAMPLE_COLOR, RECAP_TEXT_1, RECAP_TEXT_2, SLIDER_REMINDER } from './tutorial-text-continuous.js';
...
class TutorialObservationContinuousPlugin {
  ...
  trial(display_el, trial) {
    ...
    if (showClock) {
      ...
      // simple fade instead -- the same fallback continuous-draw-
      ...
      // continuous.js's own `stopClock` cleanup.
