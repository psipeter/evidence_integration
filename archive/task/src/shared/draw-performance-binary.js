 ...
 *             circle, matching draw-performance-continuous.js's own
 ...
 *             (mirrors draw-performance-continuous.js's redesign) and a
 ...
 *             on `errorMode` (see bonus-continuous.js's own docstring for
 ...
 *                           bonus-continuous.js's computeRunningRatios).
 ...
 *      draw-performance-continuous.js's own _numberLine) fixes this as a
 *      side effect, not just cosmetically -- there's no longer an opaque
 *      shape drawn on top of it at all.
 *   2. (Separately, bonus-continuous.js) the reward formula itself was
 ...
 * figure. Removed (chat history, mirrors continuous's identical change):
 ...
 * else. Error line uses VIOLET, not continuous's green -- green is
 ...
 */
import { computeRunningRatios } from './bonus-continuous.js';
