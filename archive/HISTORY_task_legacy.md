# archive/HISTORY_task_legacy.md — retired task/ (JATOS) pipeline & sequence-generation debate

Archived, frozen narrative. Not live documentation — for current task
conventions see task_backend/CLAUDE.md; for the decisions this narrative
led to, see docs/DECISIONS.md. This is the detailed diagnostic trail
behind those decisions and the full design history of the now-retired
task/ (JATOS/MindProbe) online experiment.
