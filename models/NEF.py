...
# NEF_DEFAULT_N_SIMS and simulate_ensemble() (NEF's multi-seed NLL
# ensemble) were retired -- too expensive to run at scale. See
# docs/DECISIONS.md and archive/models/archive_NEF_simulate_ensemble.py.
